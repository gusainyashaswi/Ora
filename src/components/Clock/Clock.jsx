  ...
  return (
    <div className="flex flex-col justify-between items-center w-full min-h-[calc(100vh-82px)] px-12 py-16 text-black select-none">
      ...
      <div className="flex flex-col items-center justify-center w-full">
        <div className="text-6xl font-bold italic px-8 py-4 mb-10">Today is your day.</div>
        <div className="flex items-baseline justify-center">
          <h1 className="font-sans font-bold text-[17vw] tracking-tighter leading-none font-mono tabular-nums text-black mb-30">
            {formattedHours}:{formattedMinutes}:{formattedSeconds}
          </h1>
          {!is24Hour && (
            <span className="text-[3vw] font-bold ml-[1vw] uppercase text-gray-400 font-mono pb-[2.2vw] mb-30">
              {ampm}
            </span>
          )}
        </div>
      ...
      <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-gray-300/30 pt-8 mt-4">
        ...
        <div className="text-center flex flex-col items-center gap-0.5">
          <span className="text-sm font-bold text-gray-700">
            Sun: {solar.sunrise} - {solar.sunset} ({solar.length})
          </span>
